						...
						<div class="card-body">
								<div class="media d-flex">
										<div class="media-body text-left">
												...
												<h6>Të hyrat në 30 ditët e fundit!</h6>
										</div>
										<div>
						...
						<div class="card-body">
								<div class="media d-flex">
										<div class="media-body text-left">
												...
												<h6>Shpenzimet në 30 ditët e fundit!</h6>
										</div>
										<div>
...
<div class="row match-height">
    ...
    {{-- <div class="col-xl-6 col-6" id="ecommerceChartView">
        ...
        <div class="card-header card-header-transparent py-20">
            ...
            <a href="#" class="text-body dropdown-toggle blue-grey-700" data-toggle="dropdown">Shitjet e Produkteve</a>
            <div class="dropdown-menu animate" role="menu">
                <a class="dropdown-item" href="#" role="menuitem">Shitjet</a>
                <a class="dropdown-item" href="#" role="menuitem">Shitjet Totale</a>
                <a class="dropdown-item" href="#" role="menuitem">Fitimi</a>
            </div>
            </div>
            <ul class="nav nav-pills nav-pills-rounded chart-action float-right btn-group" role="group">
            <li class="nav-item"><a class="active nav-link" data-toggle="tab" href="#scoreLineToDay">Ditë</a></li>
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#scoreLineToWeek">Javë</a></li>
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#scoreLineToMonth">Muaj</a></li>
            </ul>
        </div>
