...
@push('breadcrumb')
<h3 class="content-header-title">Stafi</h3>
<div class="row breadcrumbs-top">
	<div class="breadcrumb-wrapper col-12">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a>
			</li>
			<li class="breadcrumb-item"><a href="javascript:void(0)">Stafi</a>
			</li>
			<li class="breadcrumb-item active">Të Gjithë Stafin
			</li>
		</ol>
	</div>
</div>
...
<x-buttons.primary :text="'Shto Staf'" :target="'#add-staff'" />
@endpush
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Lista e Titujve të Pozicionit</h4>
                ...
                <table class="table table-striped table-bordered dataex-html5-export">
                  ...
                  <tbody>
                    @if (!empty($staff->count()))
                        ...
                        @endforeach
                        <x-modals.delete :route="'staff.destroy'" :title="'Stafi'" />
	...
	<div class="modal-dialog" role="document">
	  <div class="modal-content">
		<div class="modal-header">
		  <label class="modal-title text-text-bold-600" id="myModalLabel33">Shto Pozicion për Staf</label>
		...
		<form method="post" enctype="multipart/form-data" action="{{route('staff')}}">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="position-relative has-icon-left">
						<input type="text" id="address" class="form-control" placeholder="adresa e klientit" name="address">
						<div class="form-control-position">
				...
				<div class="form-group">
					<label>Paga</label>
						...
						<input type="number" class="form-control" placeholder="Paga" name="salary">
			...
			<div class="modal-footer">
				...
				<button type="submit" name="add_staff" class="btn btn-outline-primary btn-lg">Dërgo</button>
			</div>
		</form>
	  </div>
	</div>
