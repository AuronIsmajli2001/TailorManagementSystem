...
@push('breadcrumb')
<h3 class="content-header-title">Matjet</h3>
<div class="row breadcrumbs-top">
	<div class="breadcrumb-wrapper col-12">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a>
			</li>
			<li class="breadcrumb-item"><a href="#">Matjet</a>
			</li>
			<li class="breadcrumb-item active">Të Gjitha Matjet e Klientëve
			</li>
		</ol>
	</div>
</div>
...
<x-buttons.primary :text="'Shto Porosi'" :target="'#add-order'" />
@endpush
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
			<h4 class="card-title">Lista e Porosive</h4>
                ...
                <table class="table table-striped table-bordered dataex-html5-export">
                  ...
                  <tbody>
                    @if (!empty($orders->count()))
                        ...
                        @endforeach
						<x-modals.delete :route="'order.destroy'" :title="'Porosia e Klientit'" />
                    @endif                    
                  </tbody>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<label class="modal-title text-text-bold-600" id="myModalLabel33">Shto Porosi</label>
			...
			<form method="post" action="{{route('orders')}}">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<select name="customer" title="zgjidh klientin" class="select2 form-control">
							<optgroup>								 
					...
					<div class="form-group">
						<textarea class="form-control" placeholder="shkruaj përshkrimin këtu" name="description"></textarea>
					</div>
					...
					<label>Marrë nga: </label>
					<div class="form-group">
						<input type="text" placeholder="Shkruaj emrin e marrësit" name="receiver" class="form-control">
					</div>

					<label>Shuma: </label>
					<div class="form-group">
						<input type="text" placeholder="Shkruaj shumën e ngarkuar" name="amount_charged" class="form-control">
					</div>

					<label>Paguar: </label>
					<div class="form-group">
						<input type="text" name="amount_paid" class="form-control" placeholder="Shkruaj shumën e paguar">
					</div>

					
					<label>Data e Tërheqjes: </label>
					<div class="form-group">
				...
				<div class="modal-footer">
					...
					<button class="btn btn-outline-primary btn-lg" type="submit">Dërgo</button>
				</div>
			</form>
		</div>
	</div>
