        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item {{ Request::routeIs('dashboard') ? 'active' : '' }}">
                <a href="{{route('dashboard')}}">
                    ...
                    <span class="menu-title" data-i18n="Dashboard">Paneli kryesor</span>
                </a>
            </li>
            ...
            <li class="{{ Request::routeIs('orders') ? 'active' : '' }} nav-item">
                <a href="{{route('orders')}}">
                    ...
                    <span class="menu-title" data-i18n="Order">Porosite</span>
                </a>
            </li>
            ...
            <li class="{{ Request::routeIs('customers') ? 'active' : '' }} nav-item">
                <a href="{{route('customers')}}">
                    ...
                    <span class="menu-title" data-i18n="Customers">Klientet</span>
                </a>
            </li>
            ...
            <li class="{{ Request::routeIs('users') ? 'active' : '' }} nav-item">
                <a href="{{route('users')}}">
                    ...
                    <span class="menu-title" data-i18n="Users">Perdoruesit</span>
                </a>
            </li>
            <li class=" nav-item">
                <a href="#">
                    <i class="material-icons">people_outline</i>
                    <span class="menu-title" data-i18n="Staff">Menaxhmenti i Stafit</span>
                </a>
                <ul class="menu-content">
                    <li class="{{ Request::routeIs('designations') ? 'active' : '' }}">
                        <a class="menu-item" href="{{route('designations')}}">
                            <i class="material-icons"></i>
                            <span data-i18n="designations">Dizajnimi</span>
                        </a>
                    </li>
                    <li class="{{ Request::routeIs('staff') ? 'active' : '' }}">
                        <a class="menu-item" href="{{route('staff')}}">
                            <i class="material-icons"></i>
                            <span data-i18n="staff">Stafi</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item">
                <a href="#">
                    ...
                    <span class="menu-title" data-i18n="Expense management">Menagjimi i Shpenzimeve</span>
                </a>
                <ul class="menu-content">
                    <li class="{{ Request::routeIs('expense-categories') ? 'active' : '' }}">
                        <a class="menu-item" href="{{route('expense-categories')}}">
                            <i class="material-icons"></i>
                            <span data-i18n="Expense Categories">Kategorite e Shpenzimeve</span>
                        </a>
                    </li>
                    <li class="{{ Request::routeIs('expenses') ? 'active' : '' }}">
                        <a class="menu-item" href="{{route('expenses')}}">
                            <i class="material-icons"></i>
                            <span data-i18n="Expenses">Shpenzimet</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item">
                <a href="#">
                    ...
                    <span class="menu-title" data-i18n="Income management">Menaxhimi i te ardhurave</span>
                </a>
                <ul class="menu-content">
                    <li class="{{ Request::routeIs('income-categories') ? 'active' : '' }}">
                        <a class="menu-item" href="{{route('income-categories')}}">
                            <i class="material-icons"></i>
                            <span data-i18n="Income Categories">Kategoria e te ardhurave</span>
                        </a>
                    </li>
                    <li class="{{ Request::routeIs('income') ? 'active' : '' }}">
                        <a class="menu-item" href="{{route('income')}}">
                            <i class="material-icons"></i>
                            <span data-i18n="Income">Te ardhurat</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item">
                <a href="#">
                    ...
                    <span class="menu-title" data-i18n="Measurement Settings">Rregullimi i Matjeve</span>
                </a>
                <ul class="menu-content">
                    <li class="{{ Request::routeIs('cloth-types') ? 'active' : '' }}">
                        <a class="menu-item" href="{{route('cloth-types')}}">
                            <i class="material-icons"></i>
                            <span data-i18n="Cloth Types">Llojet e Rrobave</span>
                        </a>
                    </li>
                    <li class="{{ Request::routeIs('measurement-parts') ? 'active' : '' }}">
                        <a class="menu-item" href="{{route('measurement-parts')}}">
                            <i class="material-icons"></i>
                            <span data-i18n="Measurement Parts">Matjet e Pjeseve</span>
                        </a>
                    </li>
