...
@push('breadcrumb')
<h3 class="content-header-title">Llojet e Rrobave</h3>
<div class="row breadcrumbs-top">
	<div class="breadcrumb-wrapper col-12">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a>
			</li>
			<li class="breadcrumb-item"><a href="javascript:void(0)">Llojet e Rrobave</a>
			</li>
			<li class="breadcrumb-item active">Të Gjitha Llojet e Rrobave
			</li>
		</ol>
	</div>
</div>
...
<x-buttons.primary :text="'Shto Lloj Rrobe'" :target="'#add-cloth-type'" />
@endpush
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Lista e Llojeve të Rrobave</h4>
                ...
                <table class="table table-striped table-bordered dataex-html5-export">
                  ...
                  <tbody>
                    @if (!empty($cloth_types->count()))
                        ...
                        @endforeach
                        <x-modals.delete :route="'cloth-type.destroy'" :title="'Lloji i Rrobave'" />
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<label class="modal-title text-text-bold-600" >Ndrysho Llojet e Rrobave</label>
										...
										<div class="modal-body">
											<div class="form-body">
												...
												<div class="form-group">
													<label>Emri i Llojit të Rrobës: </label>
													<input type="text" class="form-control edit_name" placeholder="Emri i Llojit të Rrobës" name="name">
												</div>
												<div class="form-group">
													<label>Gjinia: </label>
													<select name="gender" class="form-control edit_gender">
														<option selected disabled value="Null">Zgjidh Gjininë</option>
...
<div class="modal zoomIn text-left" id="add-cloth-type" tabindex="-1" role="dialog" aria-labelledby="add-cloth-type" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<label class="modal-title text-text-bold-600" id="myModalLabel33">Shto Llojet e Rrobave</label>
				<button type="button" class="close text-dark" data-dismiss="modal" aria-label="Mbyll">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form method="post" action="{{route('cloth-types')}}">
				...
				<div class="modal-body">
					<div class="form-body">
						<div class="form-group">
							<label>Emri i Llojit të Rrobës: </label>
							<input type="text" class="form-control" placeholder="Emri i Llojit të Rrobës" name="name">
						</div>
						<div class="form-group">
							<label>Gjinia: </label>
				...
				<div class="modal-footer">
					<button type="reset" class="btn btn-outline-secondary btn-lg" data-dismiss="modal">Mbyll</button>						
					<button type="submit" name="add" class="btn btn-outline-primary btn-lg">Dërgo</button>
				</div>
			</form>
		</div>
	</div>
