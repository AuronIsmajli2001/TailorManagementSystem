...
@push('breadcrumb')
<h3 class="content-header-title">Kategoritë e Të Ardhurave</h3>
<div class="row breadcrumbs-top">
	<div class="breadcrumb-wrapper col-12">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a>
			</li>
			<li class="breadcrumb-item"><a href="javascript:void(0)">Kategoria e Të Ardhurave</a>
			</li>
			<li class="breadcrumb-item active">Të Gjitha Kategoritë e Të Ardhurave
			</li>
		</ol>
	</div>
</div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Lista e Kategorive të Të Ardhurave</h4>
                ...
                <table class="table table-striped table-bordered dataex-html5-export">
                  ...
                  <tbody>
                    @if (!empty($categories->count()))
                        ...
                        @endforeach
                        <x-modals.delete :route="'income-category.destroy'" :title="'Kategoria e Të Ardhurave'" />
                        <!-- edit income category modal starts here -->
                        <div class="modal wobble text-left" id="edit-category" tabindex="-1" role="dialog"  aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <label class="modal-title text-text-bold-600" id="myModalLabel33">Ndrysho Kategorinë e Të Ardhurave</label>
...
<div class="modal zoomIn text-left" id="add-category" tabindex="-1" role="dialog" aria-labelledby="AddCustomer" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<label class="modal-title text-text-bold-600" id="myModalLabel33">Shto Kategori të Të Ardhurave</label>
				<button type="button" class="close text-dark" data-dismiss="modal" aria-label="Mbyll">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
