...
@push('breadcrumb')
<h3 class="content-header-title">Të Ardhurat</h3>
<div class="row breadcrumbs-top">
	<div class="breadcrumb-wrapper col-12">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a>
			</li>
			<li class="breadcrumb-item"><a href="javascript:void(0)">Të Ardhurat</a>
			</li>
			<li class="breadcrumb-item active">Të Gjitha Të Ardhurat
			</li>
		</ol>
	</div>
</div>
...
<x-buttons.primary :text="'Shto të Ardhura'" :target="'#add-income'" />
@endpush
...
<section id="html5">
	<div class="row">
		...
		<div class="card">
			...
			<h4 class="card-title">Lista e Të Ardhurave</h4>
			...
			<div class="card-body card-dashboard">
				...
				<table class="table table-striped table-bordered dataex-html5-export">
					...
					@if (!empty($incomes->count()))
						...
						@endforeach
						{{-- delete income modal  --}}
						<x-modals.delete :route="'income.destroy'" :title="'Të Ardhurat'" />
						...
						<div class="modal wobble text-left" id="edit-income" tabindex="-1" role="dialog" aria-hidden="true">
							...
							<div class="modal-content">
								...
								<label class="modal-title text-text-bold-600" id="myModalLabel33">Ndrysho të Ardhurat</label>
								...
								<form method="post" action="{{route('income')}}">
									...
									<div class="modal-body">
										...
										<div class="form-group">
											...
											<textarea rows="3" class="form-control edit_description" name="description" placeholder="përshkrimi i të ardhurave"></textarea>
										</div>
									...
									<div class="form-group">
											...
											<div class="input-group mt-0">
												...
												<input type="number" class="form-control edit_amount" placeholder="shkruaj shumën" name="amount">
...
<div class="modal wobble text-left" id="add-income" tabindex="-1" role="dialog" aria-labelledby="AddCustomer" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<label class="modal-title text-text-bold-600" id="myModalLabel33">Shto të Ardhura</label>
				<button type="button" class="close text-dark" data-dismiss="modal" aria-label="Mbyll">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form method="post" action="{{route('income')}}">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<textarea id="description" rows="3" class="form-control" name="description" placeholder="përshkrimi i të ardhurave"></textarea>
					</div>
				...
				<div class="form-group">
						...
						<div class="input-group mt-0">
							...
							<input type="number" id="amount" class="form-control" placeholder="shkruaj shumën" name="amount">
							<div class="input-group-append">
								<span class="input-group-text">.00</span>
							</div>
						</div>
