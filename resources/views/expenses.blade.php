...
@push('breadcrumb')
<h3 class="content-header-title">Shpenzimet</h3>
<div class="row breadcrumbs-top">
	<div class="breadcrumb-wrapper col-12">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a>
			</li>
			<li class="breadcrumb-item"><a href="javascript:void(0)">Shpenzimi</a>
			</li>
			<li class="breadcrumb-item active">Të Gjitha Shpenzimet
			</li>
		</ol>
	</div>
</div>
...
<x-buttons.primary :text="'Shto Shpenzim'" :target="'#add-expense'" />
@endpush
...
<section id="html5">
	<div class="row">
		...
		<div class="card">
			...
			<h4 class="card-title">Lista e Shpenzimeve</h4>
			...
			<div class="card-body card-dashboard">
				...
				<table class="table table-striped table-bordered dataex-html5-export">
					...
					@if (!empty($expenses->count()))
						...
						@endforeach
						<x-modals.delete :route="'expense.destroy'" :title="'Shpenzimi'" />
						...
						<div class="modal wobble text-left" id="edit-expense" tabindex="-1" role="dialog" aria-hidden="true">
							...
							<div class="modal-content">
								...
								<label class="modal-title text-text-bold-600" id="myModalLabel33">Ndrysho Shpenzimin</label>
								...
								<form method="post" action="{{route('expenses')}}">
									...
									<div class="modal-body">
										...
										<div class="form-group">
											...
											<textarea rows="3" class="form-control edit_description" name="description" placeholder="përshkrimi i shpenzimit"></textarea>
										</div>
										...
										<div class="form-group">
											...
											<div class="input-group mt-0">
												...
												<input type="number" class="form-control edit_price" placeholder="shkruaj shumën e shpenzimit" name="price">
...
<div class="modal wobble text-left" id="add-expense" tabindex="-1" role="dialog" aria-labelledby="AddCustomer" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<label class="modal-title text-text-bold-600" id="myModalLabel33">Shto Shpenzim</label>
				<button type="button" class="close text-dark" data-dismiss="modal" aria-label="Mbyll">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form method="post" action="{{route('expenses')}}">
				...
				<div class="modal-body">
					...
					<div class="form-group">
					<label for="description">Përshkrimi</label>
					<textarea id="description" rows="3" class="form-control" name="description" placeholder="përshkrimi i shpenzimit"></textarea>
					</div>
					...
					<div class="form-group">
						...
						<div class="input-group mt-0">
							...
							<input type="number" id="price" class="form-control" placeholder="shkruaj shumën e shpenzimit" name="price">
							<div class="input-group-append">
								<span class="input-group-text">.00</span>
							</div>
						</div>
